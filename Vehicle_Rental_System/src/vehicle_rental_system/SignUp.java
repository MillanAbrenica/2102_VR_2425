...
public class SignUp extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(60, 60, 60)
                                    .addComponent(AdminRb, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
       ...
       String fullName, email, Password, query, role;
       ...
       try{
           ...
           if (AdminRb.isSelected()){
               role = "Admin";
               query = "INSERT INTO admin (full_name, email, password, role) VALUES ('" + fullName + "', '" + email + "', '" + Password + "', '" + role + "')";
               st.executeUpdate(query);
           }else{
              role = "Client";
              query = "INSERT INTO client (full_name, email, password, role) VALUES ('" + fullName + "', '" + email + "', '" + Password + "', '" + role + "')";
              st.executeUpdate(query);
           }
